...
''';
  ...
  static  Future<void> CriaTabelaSimulaForm(String tb)async{
    ...
    sql+='nivel varchar(1) DEFAULT NULL,';
    sql+='label varchar(200) DEFAULT NULL,';
    sql+='tipo varchar(50) DEFAULT NULL,';
    sql+='titulo varchar(150) DEFAULT NULL,';
  ...
  static  Future<List<dynamic>> CriaTabelaSimulaCab(String tb)async{
    ...
    sql+='classes int(11) NOT NULL DEFAULT 15,';
    sql+='progressao decimal(5,2) NOT NULL DEFAULT 2.8,';
    sql+='created_at timestamp NULL DEFAULT CURRENT_TIMESTAMP);';
